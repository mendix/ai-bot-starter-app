...
public class Retrieve extends CustomJavaAction<IMendixObject>
{
	...
	private final amazonbedrockconnector.proxies.RetrieveRequest RetrieveRequest;
	...
	)
	{
		...
		this.RetrieveRequest = _retrieveRequest == null ? null : amazonbedrockconnector.proxies.RetrieveRequest.initialize(getContext(), _retrieveRequest);
	}
